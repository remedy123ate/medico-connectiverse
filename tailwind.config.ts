		...
		extend: {
			colors: {
				...
				medico: {
					...
					white: "#ffffff",
					hope: "#9b87f5", // New soft purple color for hopeful accents
					inspire: "#D3E4FD" // New soft blue for inspirational elements
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			animation: {
				...
				'gradient-x': 'gradient-x 10s infinite ease-in-out'
			},
			fontFamily: {
